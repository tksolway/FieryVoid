...
window.createGame = {
    ...
    doGameSpaceCheck: function(data){
      ...
      if(checkval == "on"){
          ...
          $(".deptype").val("box");
          $("#team1 .points").val(3500);
          $("#team2 .points").val(3500);
          $("#team1 .depx").val(-19.5);
          $("#team2 .depx").val(18.5);
          $("#team1 .depy").val(0);
          $("#team2 .depy").val(0);
          $("#team1 .depwidth").val(4);
          $("#team2 .depwidth").val(4);
          $("#team1 .depheight").val(30);
          $("#team2 .depheight").val(30);
          createGame.slots[0].points = 3500;
          createGame.slots[1].points = 3500;
          createGame.slots[0].depx = -19.5;
          createGame.slots[1].depx = 18.5;
          createGame.slots[0].depy = 0;
          createGame.slots[1].depy = 0;
          createGame.slots[0].depwidth = 4;
          createGame.slots[1].depwidth = 4;
