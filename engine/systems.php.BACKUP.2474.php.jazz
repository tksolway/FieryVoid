...
>>>>>>> 49c33fdec77997e0df03d9a34a29ec23cdfc630e
...
>>>>>>> 49c33fdec77997e0df03d9a34a29ec23cdfc630e
    ...
    */
    ...
    public function calculateHit($gamedata, $fireOrder){
        ...
        $defense = $defense - $target->getHitChangeMod($shooter, 0, 0);
    ...
    protected function getFinalDamage($shooter, $target, $pos, $gamedata){
        ...
        // Each shot is reduced by any damage modifiers. (Only shields implemented atm.)
        $damage = $this->getDamage() - $target->getDamageValueMod($shooter, 0, 0);
